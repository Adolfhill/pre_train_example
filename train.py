...
parser.add_argument("--model_name_or_path", type=str, default="D:/学习/nlp/exps/exp4/bert2", required=False)
parser.add_argument("--prepro_data_dir", type=str, default="prepro_data", required=False)
...
parser.add_argument('--save_name', type = str, required=False, default= 'default')
